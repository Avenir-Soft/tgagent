  ...
  return (
    <>
      ...
      >
        ...
        {/* ── Platform switch (super_admin only) ── */}
        {user?.role === "super_admin" && (
          <div className="px-3 pt-2">
            <a
              href="/platform-overview"
              className="flex items-center gap-2 px-3 py-2 rounded-lg text-[12px] font-medium text-slate-400 hover:text-indigo-400 hover:bg-indigo-500/10 border border-white/[0.06] hover:border-indigo-500/30 transition-all w-full"
            >
